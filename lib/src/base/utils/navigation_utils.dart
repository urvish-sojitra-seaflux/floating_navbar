...
import 'package:flutter_boilerplate/src/ui/samples/bottom_navigation_bar/draggable_navbar_1.dart';
...
class NavigationUtils {
  ...
  Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case routeDraggableNavbar1:
        return MaterialPageRoute(
          settings: settings,
          builder: (_) =>
              const DraggableNavbar1(), // To pass args use as const LoginScreen(id: args?["id"])
        );
      default:
